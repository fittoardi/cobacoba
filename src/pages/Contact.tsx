  ...
  return (
    <div className="pt-32 pb-20">
      <div className="container mx-auto px-4">
          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-1">Main Location</h3>
            ...
            {/* Customer Rating */}
            <div className="bg-gradient-to-r from-sky-50 to-teal-50 rounded-xl p-6">
              <div className="flex items-center space-x-3 mb-3">
        ...
        {/* Map Section */}
        <div className="bg-gradient-to-r from-slate-50 to-white rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
            <div className="text-center">
              <h3 className="font-semibold text-gray-900 mb-2">Main Store</h3>
              <p className="text-gray-600 text-sm">123 Aquatic Boulevard, Marina District</p>
            </div>
            <div className="text-center">
              <h3 className="font-semibold text-gray-900 mb-2">Parking</h3>
              <p className="text-gray-600 text-sm">Free parking available in front and rear</p>
            </div>
            <div className="text-center">
              <h3 className="font-semibold text-gray-900 mb-2">Public Transit</h3>
              <p className="text-gray-600 text-sm">Bus routes 12, 34, and 56 stop nearby</p>
            </div>
          </div>
        </div>
      </div>
